...
{
    [Collection("Tags")]
    public class SqlServerQueryInfixTests : IDisposable
    {
        private readonly DataContext _ctx;
        private string _lastSql;

        public SqlServerQueryInfixTests()
        {
        ...
        public void QueryOnlyTagWith(PredicateExpression predicateExpression)
        {
            ...
            DbInterceptionUtils.AddInterceptorAndRemovePrevious(
                new QueryTaggerInterceptor(new SqlServerTagger(), new TaggingOptions() { TagMode = TagMode.Infix }, s => _lastSql = s));
        ...
        {
            DbInterceptionUtils.AddInterceptorAndRemovePrevious(
                new QueryTaggerInterceptor(new SqlServerTagger(), new TaggingOptions() { TagMode = TagMode.Infix, PredicateExpression = predicateExpression }, s => _lastSql = s));
        }
    }
}
